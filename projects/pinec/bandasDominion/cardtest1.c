...
int main() {
    ...
    adventurerCard(&drawnTreasure, &testG, thisPlayer, &cardDrawn, &z);
    ...
    printf("new vs expected deck count:\n");
    totalAsserts += myAssert(testG.deckCount[thisPlayer], 0);  //all drawn cards should of been discarded since none were treasures
    printf("new vs expected hand count:\n");
    totalAsserts += myAssert(testG.handCount[thisPlayer], G.handCount[thisPlayer] + 2);
    printf("new vs expected discardCount:\n");
    totalAsserts += myAssert(testG.discardCount[thisPlayer], G.discardCount[thisPlayer] + G.deckCount[thisPlayer] - 2); //all drawn cards discarded except for treasures
