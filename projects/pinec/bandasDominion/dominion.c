...
int adventurerCard(int *drawntreasure, struct gameState *state, int currentPlayer, int* cardDrawn, int* z) {
  int temphand[MAX_HAND]; //looks like we need to adjust for this full temphand in our random test.
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerCard(drawntreasure, state, currentPlayer, cardDrawn, z);
      break;
