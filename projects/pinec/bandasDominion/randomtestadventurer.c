...
int checkAdventurerCard(int *dTreasure, struct gameState *post, int cPlayer, int* cDrawn, int* z) {
...
//  printf("number of playas: %d\n", post->numPlayers);
    ...
    r = adventurerCard(dTreasure, post, cPlayer, cDrawn, z);
...
int main () {
    ...
    for (n = 0; n < 2000; n++) {
        ...
        checkAdventurerCard(&drawnTreasure, &G, p, &cardDrawn, &z);
